...
function handleMouseMove(event) {
  ...
  const noteButton = event.target?.closest?.(".gr-direct-note-button, .gr-direct-note-status-marker, .gr-direct-note-id-button");
...
function injectStyle() {
  ...
  style.textContent = [
    ...
    "  font: 700 15px/18px \"Segoe UI Emoji\", \"Apple Color Emoji\", \"Noto Color Emoji\", Arial, sans-serif !important;",
    "  text-align: center !important;",
